...
private let logger = Logger(subsystem: "com.hermesisland", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.hermesisland.agentfilewatcher", qos: .userInitiated)
